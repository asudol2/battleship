...
def test_ship_getters():
    ship = Ship(4, 'poziom', [(3,2), (3,3), (3,4), (3,5)])
...
def test_fleet_getter():
    ship1 = Ship(4, 'poziom', [(3,2), (3,3), (3,4), (3,5)])
    ship2 = Ship(3, 'pion', [(2,6), (3,6)])
...
def test_fleet_setter():
    ...
    ship2 = Ship(3, 'pion', [(2,6), (3,6)])
    fleet = Fleet([ship1, ship2])
    ship3 = Ship(3, 'poziom', [(5,2), (5,3), (5,4)])
    ship4 = Ship(2, 'poziom', [(2,6), (2,7)])
...
def test_fleet_get_list_of_cords():
    ...
    ship2 = Ship(3, 'pion', [(2,6), (3,6)])
    fleet = Fleet([ship1, ship2])
    assert fleet.get_list_of_cords() == [[(3,2), (3,3), (3,4), (3,5)], [(2,6), (3,6)]]
...
def test_fleet_fleet_is_not():
    ...
    fleet.remove_ship_from_fleet(ship2)
    assert fleet.if_fleet_is() == False
